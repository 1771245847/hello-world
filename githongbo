...
const interfaces = [
	{name:"安歌",type:3,url:"https://z1.m1907.cn/?jx="},
    {name:"景云",type:3,url:"https://api.3jx.top/vip/?url="},
    {name:"博衍",type:3,url:"https://api.8bjx.cn/?url="},
    {name:"云逸",type:3,url:"https://api.iztyy.com/jiexi/?url="},
    {name:"爱看",type:3,url:"https://ak.vipsli.com/ak/index.php?url="},
    {name:"风藤",type:3,url:"http://bofang.online/?url="},
    {name:"秋桑",type:3,url:"http://playx.top/?url="},
    {name:"凌泉",type:3,url:"http://beijixs.cn/?url="},
    {name:"天冬",type:3,url:"http://nitian9.com/?url="},
    {name:"黑白",type:3,url:"http://www.zhezhi.ren/jk/HByun/?url="},
    {name:"文竹",type:3,url:"http://api.oopw.top/jiexi/?url="},
